...
function imagesExchange(sIdProd,sImagemProdPri,ImagemProdDet,sDescUrl,sNomeProd,ProdFiltersJS){   
    ...
    if(getBoxProd){
    getBoxProd.onmousemove=function(){getImageBox.childNodes[1].classList.add("getimgTwo")};
    getBoxProd.onmouseout=function(){if(getImageBox.childNodes[1].className=="imgTwo getimgTwo"){getImageBox.childNodes[1].classList.remove("getimgTwo")}}

 
      getBoxProd.addEventListener('touchmove', function(e) {  
    ...
    // GET TYPE IMG DETAILS IMGE DOBLE 
    if(ImagemProdDet){   
